...
if(cluster){
  ...
  meta_file = '/home/bst/student/ywebbvar/Github/functional_mediation/meta.mat'
  }else{
...
time3 = Sys.time()
stat = boot(data = big_dta, statistic = fbootstrap_ML,R = 9,sim = "ordinary",stype = "i",parallel = "multicore",ncpus=3)
time4 = Sys.time()
time4 - time3
