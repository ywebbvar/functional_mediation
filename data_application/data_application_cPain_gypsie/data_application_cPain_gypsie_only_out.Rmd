...
```{r}
time1 = Sys.time()
out1 = sfs_Mediation(x = X,y = Y,m = t(M),mediatorMethod="fosr2s", outcomeMethod="fgam",splinepars_lf=list(bs="ps",m=c(2, 1)),nbasis=nbasis,norder=norder,lambda=lambda, plot=plots, boot=FALSE)
time2 = Sys.time()

save(out1,out2, file="~/GitHub/functional_mediation/data_application/data_application_cPain_gypsie/Data_analysis_cPain_out.Rdata")
```
