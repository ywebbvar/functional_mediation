...
```r
if(cluster){
  source('/home/bst/student/ywebbvar/Github/functional_mediation/fMediation_ML.R')
  }else{
...
```
## Warning in parallel::mclapply(seq_len(RR), fn, mc.cores = ncpus):
## scheduled cores 5, 3, 8, 10, 6, 9, 2 encountered errors in user code, all
...
```
## Warning in parallel::mclapply(seq_len(RR), fn, mc.cores = ncpus):
## scheduled cores 2, 6, 7, 8, 9, 5, 4, 1 encountered errors in user code,
...
```
## Warning in parallel::mclapply(seq_len(RR), fn, mc.cores = ncpus):
## scheduled cores 5, 6, 9, 10, 8, 3 encountered errors in user code, all
## values of the jobs will be affected
```
...
```
## Warning in parallel::mclapply(seq_len(RR), fn, mc.cores = ncpus):
## scheduled cores 6, 10, 2, 8, 7, 4 encountered errors in user code, all
## values of the jobs will be affected
```
...
```
## Warning in parallel::mclapply(seq_len(RR), fn, mc.cores = ncpus):
## scheduled cores 10, 5, 8, 7, 2, 3, 1 encountered errors in user code, all
## values of the jobs will be affected
```
...
```
## Warning in parallel::mclapply(seq_len(RR), fn, mc.cores = ncpus):
## scheduled cores 4, 10, 9, 2, 3, 7, 6, 8 encountered errors in user code,
## all values of the jobs will be affected
```
...
```
## Warning in parallel::mclapply(seq_len(RR), fn, mc.cores = ncpus):
## scheduled core 1, 10, 5, 7 encountered error in user code, all values of
## the job will be affected
```

```
## Warning in parallel::mclapply(seq_len(RR), fn, mc.cores = ncpus):
## scheduled cores 9, 6, 1, 2, 4, 7, 8 encountered errors in user code, all
## values of the jobs will be affected
```
...
```
## Warning in parallel::mclapply(seq_len(RR), fn, mc.cores = ncpus):
## scheduled cores 7, 4, 10, 1, 9, 3, 6, 2 encountered errors in user code,
## all values of the jobs will be affected
```
...
```
## Warning in parallel::mclapply(seq_len(RR), fn, mc.cores = ncpus):
## scheduled cores 6, 3, 4, 10, 1, 5, 9, 8 encountered errors in user code,
## all values of the jobs will be affected
```

```
## Warning in parallel::mclapply(seq_len(RR), fn, mc.cores = ncpus):
## scheduled cores 5, 7, 3, 10, 6, 1, 4 encountered errors in user code, all
## values of the jobs will be affected
```
...
```
## Warning in parallel::mclapply(seq_len(RR), fn, mc.cores = ncpus):
## scheduled cores 8, 10, 4, 3, 1, 7 encountered errors in user code, all
## values of the jobs will be affected
```
...
```
## Warning in parallel::mclapply(seq_len(RR), fn, mc.cores = ncpus):
## scheduled cores 8, 4 encountered errors in user code, all values of the
## jobs will be affected
```
...
```
## Warning in parallel::mclapply(seq_len(RR), fn, mc.cores = ncpus):
## scheduled cores 10, 4, 5, 6, 8, 9, 7, 1 encountered errors in user code,
## all values of the jobs will be affected
```
...
```
## Warning in parallel::mclapply(seq_len(RR), fn, mc.cores = ncpus):
## scheduled cores 7, 1, 6, 9, 10, 4, 8, 2, 5 encountered errors in user
## code, all values of the jobs will be affected
```
...
```
## Warning in parallel::mclapply(seq_len(RR), fn, mc.cores = ncpus):
## scheduled cores 8, 4, 7, 3 encountered errors in user code, all values of
## the jobs will be affected
```
...
```
## Warning in parallel::mclapply(seq_len(RR), fn, mc.cores = ncpus):
## scheduled cores 6, 2, 7 encountered errors in user code, all values of the
## jobs will be affected
```
...
```
## Warning in parallel::mclapply(seq_len(RR), fn, mc.cores = ncpus):
## scheduled cores 3, 5, 4, 1, 7, 2 encountered errors in user code, all
## values of the jobs will be affected
```
...
```
## Warning in parallel::mclapply(seq_len(RR), fn, mc.cores = ncpus):
## scheduled cores 7, 10, 6, 9, 2, 5 encountered errors in user code, all
## values of the jobs will be affected
```
