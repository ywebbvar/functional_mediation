...
for(i in 1:iters){
  ...
  ptime[[i]] = system.time(stat <- boot(data = dta, statistic = fbootstrap_ML,R = nboot,sim = "ordinary",stype = "i"))
...
save(A,B,C,CP,Pall,Pall2, file=paste0("Simulation_test_",format(Sys.time(), "%Y%m%d-%H%M"),".Rdata"))
```
