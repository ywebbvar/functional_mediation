...
This implements simulation for testing my functional mediation function. I use an 'error-less' mediator in constructing $Y$.
...
for(i in 1:iters){
  ...
  design_M_Y <- cbind(int=1,X=X,M=t(tcrossprod(coeff_M, design_M)))
